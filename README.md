...
From here, we can visualize our search results with our included audio player. The player should work with no additional configuration but the bulk of the logic is here:
